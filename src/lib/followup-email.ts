...
function bodyHtml(trade: string): string {
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #0b1b3b; line-height: 1.5;">
    ...
    <p>Here are some demo systems so you can have an idea of what it might look like:<br>
      <a href="https://electrician-crm.vercel.app" style="color:#4d7c0f;">https://electrician-crm.vercel.app</a><br>
      <a href="https://construction-crm.vercel.app" style="color:#4d7c0f;">https://construction-crm.vercel.app</a><br>
      <a href="https://dental-crm.vercel.app" style="color:#4d7c0f;">https://dental-crm.vercel.app</a>
    </p>
...
https://electrician-crm.vercel.app
https://construction-crm.vercel.app
https://dental-crm.vercel.app
